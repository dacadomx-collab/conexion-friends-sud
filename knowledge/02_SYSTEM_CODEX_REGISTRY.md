...
#### Orden de renderizado del `<main>` (4 bloques)
...
| 3 | Lista de Usuarios Registrados (buscador + lista paginada) | Tercero |
| 4 | **Bajas / Ocultos** — registro `user_departures_log` (`id="seccion-bajas"`) | Abajo |
