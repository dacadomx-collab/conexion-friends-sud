...
| `api/upload_photos.php` | POST multipart | Valida (finfo MIME), guarda en `uploads/profiles/`, registra en `profile_photos`. Try/catch global garantiza JSON en cualquier error. |
